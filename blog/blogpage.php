            ...
            <div class="nav">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="show_post.php">Edit</a></li>
    ...
    <section id="services">
        <div class="services main-container">
            <h3 class="pre-title">This Is Our Blog</h3>
            <h1 class="section-title mom-title">Mouziki Blog</h1>

            <div class="grid-3">
                <?php foreach ($posts as $post) : ?>
                    <div class="service">
                        <div class="service-icon">
                            <img src="<?php echo $post['filename']; ?>" alt="" style="
                                    object-fit: contain;
                                    height: 100px;
                                    width: 100px;
                                    border-radius: 20px;
